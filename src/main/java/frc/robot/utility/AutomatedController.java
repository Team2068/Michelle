...
public class AutomatedController {
    ...
    public void configure(){
        ...
        controller.leftStick().onTrue(new InstantCommand(io.chassis::zeroHeading));
      
        // controller.back().onTrue(Util.Do(io.elevator::rest));
        // controller.start().onTrue(Util.Do(io.elevator::zero));

        controller.start().and(controller.getHID()::getBackButtonPressed).debounce(3).onTrue(Util.Do(this::toggleMode));
